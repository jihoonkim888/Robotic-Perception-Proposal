...
The object detection algorithm in this project must be able to perform ``amodal object detection'', i.e. to find the location, shape and orientation of an object in a scene.
