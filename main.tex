...
A similar technique could be used for scene segmentation in this project.
...
It is similar to object detection explained in Section \ref{sec:object-detection}, therefore, they are often addressed jointly \citep{sedaghat2016pose}.
The most challenging tasks for pose estimation are to detect objects and estimate their orientations concurrently, and to build an algorithm robust to changing positions of robots in an environment.
...
% Section 6.6
3D scan to CAD
Assuming the perceived data is RGB-D
